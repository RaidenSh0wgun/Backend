...
class Migration(migrations.Migration):
    ...
    initial = True
    dependencies = [
        ('quiz', '0010_delete_category_delete_course_delete_question_and_more'),
    ]
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Title', models.CharField(default='New Quiz', max_length=100, unique=True, verbose_name='Quiz Title')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'verbose_name': 'Quiz',
