...
def sync_quiz_deadline_to_calendar(sender, instance, created, **kwargs):
    """Create or update calendar events for all students enrolled in the quiz's course when quiz has a due_date."""
    ...
    # Also create/update an event for the instructor (so teacher calendar works)
